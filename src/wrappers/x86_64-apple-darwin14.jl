# Autogenerated wrapper script for sinewave_jll for x86_64-apple-darwin14
export libsinewave
...
const libsinewave_splitpath = ["lib", "libsinewave.dylib"]
...
const libsinewave = "@rpath/libsinewave.dylib"
